    ...
    class ProjectFetcherComponent extends React.Component {
        ...
        fetchProject (projectId, loadingState) {
            ...
            if (projectUrl) {
                ...
                if (window.location.hostname != "localhost" && !window.location.hostname.startsWith("editor.")) throw new Error("Unknown hostname.");
                projectUrl = `${window.location.protocol}//${window.location.hostname == "localhost" ? "localhost:3000" : window.location.hostname.replace("editor.", "", 1)}/api/project/${projectId}/download`;
            }
